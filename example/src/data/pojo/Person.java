...
public class Person implements java.io.Serializable {
    ...
    public Person(int personId, String givenname, String surname, Timestamp dateOfBirth, char gender, String email, String phoneNumber, String note, String username, String password, String authority, Set<Measuration> measurationsForOwnerId, Set<Scenario> scenarios, Set<PersonAddParamsValues> personAddParamsValueses, Set<ResearchGroupMembership> researchGroupMemberships, Set<EyesDefect> eyesDefects, Set<Measuration> measurationsForPersonId, Set<ResearchGroup> researchGroups, Set<Measuration> measurations, Set<HearingDefect> hearingDefects) {
        this.personId = personId;
